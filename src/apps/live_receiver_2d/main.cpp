...
int main(int argc, char* argv[]) {
    ...
    const std::string hrtfPathForInit =
        resolvedHrtfPath.has_value() ? *resolvedHrtfPath : customHrtfPath;
    if (!initializeSteamAudioResources(options.useDefaultHRTF, hrtfPathForInit, steamAudio)) {
        return 1;
    }
